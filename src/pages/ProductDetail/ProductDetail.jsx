            ...
            <div className='flex flex-col gap-[20px]'>
              ...
              {product.stock > 0 ? (
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#A64D79] text-center hover:bg-[#3B1C32] text-white active:bg-[#4956ab]"
                  >
                ...
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#A64D79] text-center"
                  >
                    <FontAwesomeIcon icon={faCartShopping} className="mb-0 text-white" />
