...
export default function Card({product}) {
  return (
    <Link to={`/products/${product.slug}` ?? ''} className="flex flex-col max-w-[370px] flex-wrap p-[16px] bg-[#3B1C32] hover:ring-opacity-40 active:ring-5 active:ring-[#A64D79] hover:ring-4 active:ring-2 active:ring-opacity-90" >
    <div className="flex flex-col max-w-[370px] flex-wrap p-[16px] bg-[#3B1C32]" >
                ...
                {product.stock <= 0 ? (
                    ...
                    <>
                       <p className="text-xl font-semibold text-center text-yellow-500">Almost Sold Out</p>
                        <Button type="button" className="inline-flex items-center justify-center gap-2 p-4 bg-[#A64D79] text-center hover:bg-[#6A1E55] text-white active:bg-[#4956ab]">
